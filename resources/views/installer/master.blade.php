...
<html lang="en">
    <head>
        ...
        <title>@yield('title') | {{{trans('installer::installer.title.package')}}}</title>
        ...
        <link href="{{ asset('installer/css/style'.(getenv('APP_ENV') == "production" ? ".min" : "").'.css', config('core_game.SSL_ENABLED')) }}" media="all" rel="stylesheet" type="text/css" />
